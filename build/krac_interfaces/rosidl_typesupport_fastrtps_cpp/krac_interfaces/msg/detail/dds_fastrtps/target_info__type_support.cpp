...
#include "krac_interfaces/msg/detail/target_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const krac_interfaces::msg::TargetInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  krac_interfaces::msg::TargetInfo & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: location_xyz
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.location_xyz[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = krac_interfaces::msg::TargetInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const krac_interfaces::msg::TargetInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<krac_interfaces::msg::TargetInfo *>(
    untyped_ros_message);
...
{
  return &krac_interfaces::msg::typesupport_fastrtps_cpp::_TargetInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, krac_interfaces, msg, TargetInfo)() {
  return &krac_interfaces::msg::typesupport_fastrtps_cpp::_TargetInfo__handle;
}
