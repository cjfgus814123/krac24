...
static const _FlightPhase_type_support_symbol_names_t _FlightPhase_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, krac_interfaces, msg, FlightPhase)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, krac_interfaces, msg, FlightPhase)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, krac_interfaces, msg, FlightPhase)() {
  return &::krac_interfaces::msg::rosidl_typesupport_c::FlightPhase_message_type_support_handle;
}
